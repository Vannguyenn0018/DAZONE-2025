...
* 1. Làm sao để xác định người dùng nào có khả năng quay lại mua hàng trong
tương lai?
* 2. Khách hàng nào có tiềm năng trở thành khách hàng trung thành?
* 3. Dự đoán xác suất để mỗi người dùng mới quay lại mua hàng từ cùng một gian
...
## Xử lý dữ liệu & Kỹ thuật đặc trưng (Feature Engineering)
